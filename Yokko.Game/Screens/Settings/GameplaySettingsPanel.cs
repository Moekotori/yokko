...
internal partial class GameplaySettingsPanel : CompositeDrawable, ISettingsTransientUi
{
    ...
    private readonly List<SettingsSegmentedChoiceButton> difficultyRatingButtons = new();
    ...
    private Drawable createTimingSection()
    {
        ...
        setPanelChildren(panel, new Drawable[]
        {
            ...
            createControlLabel(
                YokkoStrings.Get("settings.gameplay.difficulty_rating"),
                YokkoStrings.Get("settings.gameplay.difficulty_rating_note"),
                20,
                205),
            new Container
            {
                Position = new Vector2(430, 199),
                Child = SettingsDifficultyRatingControl.Create(
