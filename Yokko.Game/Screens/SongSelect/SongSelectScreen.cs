...
public partial class SongSelectScreen : Screen
{
    ...
    private void load(TextureStore textureStore)
    {
        ...
        InternalChildren = new Drawable[]
        {
            ...
            new Box
            {
                ...
                Width = 625,
                Colour = new Color4(SongSelectTheme.DeepNavy.R, SongSelectTheme.DeepNavy.G, SongSelectTheme.DeepNavy.B, 0.35f),
            },
            stage = new Container
            {
                ...
                Children = new Drawable[]
                {
                    ...
                    {
                        Position = new Vector2(45, 196),
                        Size = new Vector2(460, 438),
                    },
                    createSongBrowser(),
                    createFooter(),
                    new Sprite
                    {
                        Position = new Vector2(6, 594),
                        Size = new Vector2(112, 127),
                        Texture = mascot,
                    },
                    createDecorations(),
                },
    ...
    private Drawable createHeader(Texture logo) => new Container
    {
        ...
        Children = new Drawable[]
        {
            ...
            new SpriteText
            {
                Position = new Vector2(48, 132),
                Text = YokkoStrings.Get("song_select.title"),
                Font = HomeTypography.Display(44),
                Colour = SongSelectTheme.Ivory,
            },
            new Box
            {
                Position = new Vector2(48, 183),
                Size = new Vector2(330, 3),
    ...
    private Drawable createFooter()
    {
        ...
        return new Container
        {
            ...
            Size = new Vector2(designed_width, 78),
            Children = new Drawable[]
            {
                new Box
                {
