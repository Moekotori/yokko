...
namespace Yokko.Game.Tests.Visual
{
    ...
    public abstract partial class YokkoManualInputTestScene : ManualInputManagerTestScene
    {
        protected override ITestSceneTestRunner CreateRunner() =>
            new YokkoManualInputTestSceneTestRunner();

        private partial class YokkoManualInputTestSceneTestRunner : YokkoGameBase, ITestSceneTestRunner
        {
            private TestSceneTestRunner.TestRunner runner;
